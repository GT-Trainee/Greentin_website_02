    ...
    ["src_scripts_modules_NavToggle_js"], {
        ...
        "./src/scripts/modules/NavToggle.js":
            ...
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                var NavToggle = /*#__PURE__*/ function(_M) {
                    (0, _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5__["default"])(NavToggle, _M);
                    var _super = _createSuper(NavToggle);

                    function NavToggle(m) {
                        var _this;
                        (0, _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, NavToggle);
                        _this = _super.call(this, m);
                        (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])((0, _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "left", 0);
                        ...
                        (0, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])((0, _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "mouseout", function() {
                            console.log(JSON.parse(_this.getData('active')));
                            _this.to(_this.$('link')[JSON.parse(_this.getData('active'))], 0.5);
                        });
                    ...
                    (0, _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(NavToggle, [{
                        key: "init",
                        value: function init() {
                            var _this2 = this;
                            ...
                            this.$('link').forEach(function($link) {
                                $link.addEventListener('mouseover', _this2.mouseover);
                                if (JSON.parse(_this2.getData('current', $link))) {
                                    _this2.to($link);
                                }
                            });
                        ...
                        value: function to(el) {
                            ...
                            var current = (0, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(this.$('link')).indexOf(el);
                            gsap__WEBPACK_IMPORTED_MODULE_9__["default"].to(this.$('background')[0], {
                                duration: duration,
                                left: left - this.left
                            });
                            this.$('link').forEach(function($link, index) {
                ...
                const __WEBPACK_DEFAULT_EXPORT__ = (NavToggle);
...
//# sourceMappingURL=src_scripts_modules_NavToggle_js.js.map