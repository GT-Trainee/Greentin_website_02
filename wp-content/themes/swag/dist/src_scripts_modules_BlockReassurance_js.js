...
(self["webpackChunk_19h47_wordpress_theme"] = self["webpackChunk_19h47_wordpress_theme"] || []).push([
    ["src_scripts_modules_BlockReassurance_js"], {
        ...
        /***/
        "./src/scripts/animations/reassuranceAnimation.js":
            /*!********************************************************!*\
              !*** ./src/scripts/animations/reassuranceAnimation.js ***!
              \********************************************************/
            /***/
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                /* harmony import */
                var gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__( /*! gsap/DrawSVGPlugin */ "./node_modules/gsap/DrawSVGPlugin.js");


                gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_DrawSVGPlugin__WEBPACK_IMPORTED_MODULE_1__.DrawSVGPlugin);
                var reassuranceAnimation = function reassuranceAnimation(buttons, trigger, swiper) {
                    ...
                    buttons.forEach(function($button, i) {
                        var $svg = $button.querySelector('[data-block-reassurance="svg"]');
                        var $loader = $button.querySelector('[data-block-reassurance="loader"]');
                        var $title = $button.querySelector('[data-block-reassurance="title"]');
                        var label = "position-".concat(i);
                        timeline.addLabel(label);
                        timeline.add(function() {
                            return buttons.forEach(function($l) {
                        ...
                        timeline.to($loader, {
                            ...
                            onComplete: function onComplete() {
                                swiper.slideTo(i + 1 === buttons.length ? 0 : i + 1);
                            }
                        });
                    });
                    return timeline;
                ...
                const __WEBPACK_DEFAULT_EXPORT__ = (reassuranceAnimation);
        ...
        "./src/scripts/modules/BlockReassurance.js":
            ...
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                /* harmony import */
                var swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! swiper */ "./node_modules/swiper/swiper.esm.js");
                /* harmony import */
                ...
                /* harmony import */
                var gsap__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__( /*! gsap */ "./node_modules/gsap/index.js");
                /* harmony import */
                var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__( /*! gsap/ScrollTrigger */ "./node_modules/gsap/ScrollTrigger.js");
                /* harmony import */
                var animations_reassuranceAnimation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! animations/reassuranceAnimation */ "./src/scripts/animations/reassuranceAnimation.js");
                ...
                swiper__WEBPACK_IMPORTED_MODULE_5__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_5__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_5__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_5__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_5__.Pagination]);
                 ...
                 */
                var BlockReassurance = /*#__PURE__*/ function(_M) {
                    (0, _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(BlockReassurance, _M);
                    var _super = _createSuper(BlockReassurance);

                    function BlockReassurance(m) {
                        var _this;
                        (0, _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, BlockReassurance);
                    ...
                    (0, _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(BlockReassurance, [{
                        key: "init",
                        value: function init() {
                            var _this2 = this;
                            this.swiper = null;
                            ...
                            utils_environment__WEBPACK_IMPORTED_MODULE_6__.mm.add(utils_environment__WEBPACK_IMPORTED_MODULE_6__.mediaQueries.lg, function() {
                                _this2.swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](_this2.$('swiper')[0], {
                                    pagination: {
                                        el: _this2.$('fraction')[0],
                                        type: 'fraction'
                                    },
                                    speed: 0,
                                    effect: 'fade'
                                ...
                                var buttons = gsap__WEBPACK_IMPORTED_MODULE_8__["default"].utils.toArray(_this2.$('button'));
                                _this2.timeline = (0, animations_reassuranceAnimation__WEBPACK_IMPORTED_MODULE_7__["default"])(buttons, _this2.el, _this2.swiper);
                                return function() {
                                    _this2.swiper.destroy();
                                };
                            });
                            utils_environment__WEBPACK_IMPORTED_MODULE_6__.mm.add('(max-width: 1019px)', function() {
                                _this2.swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"](_this2.$('swiper')[0], {
                                    spaceBetween: 8,
                                    pagination: {
                                        el: _this2.$('fraction')[0],
                                    ...
                                    navigation: {
                                        nextEl: _this2.$('next')[0],
                                        prevEl: _this2.$('previous')[0]
                                    }
                                });
                                return function() {
                                    _this2.swiper.destroy();
                        ...
                        key: "slideTo",
                        value: function slideTo(_ref) {
                            var target = _ref.target;
                            var index = target.getAttribute('data-index');
                            this.swiper.slideTo(index);
                            this.timeline.seek("position-".concat(index));
                        }
                    }]);
                    return BlockReassurance;
                }(_19h47_modular__WEBPACK_IMPORTED_MODULE_10__.module);
                /* harmony default export */
                const __WEBPACK_DEFAULT_EXPORT__ = (BlockReassurance);
        ...
        "./node_modules/gsap/DrawSVGPlugin.js":
            ...
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                __webpack_require__.d(__webpack_exports__, {
                    /* harmony export */
                    DrawSVGPlugin: () => ( /* binding */ DrawSVGPlugin),
                    /* harmony export */
                    "default": () => ( /* binding */ DrawSVGPlugin)
                    /* harmony export */
                });
                /*!
...
//# sourceMappingURL=src_scripts_modules_BlockReassurance_js.js.map