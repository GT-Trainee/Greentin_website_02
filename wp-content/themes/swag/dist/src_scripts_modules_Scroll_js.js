    ...
    ["src_scripts_modules_Scroll_js"], {
        ...
        "./src/scripts/modules/Scroll.js":
            ...
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                /* harmony import */
                var utils_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__( /*! utils/environment */ "./src/scripts/utils/environment.js");
                /* harmony import */
                var gsap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__( /*! gsap */ "./node_modules/gsap/index.js");
                /* harmony import */
                var gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__( /*! gsap/ScrollSmoother */ "./node_modules/gsap/ScrollSmoother.js");
                ...
                gsap__WEBPACK_IMPORTED_MODULE_6__["default"].registerPlugin(gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_7__.ScrollSmoother);
                var Scroll = /*#__PURE__*/ function(_M) {
                    ...
                    (0, _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Scroll, [{
                        ...
                        value: function init() {
                            ...
                            if (!utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.classList.contains('touch')) {
                                this.scroll = gsap_ScrollSmoother__WEBPACK_IMPORTED_MODULE_7__.ScrollSmoother.create({
                                    smooth: 1.2,
                            ...
                            window.addEventListener('scroll', function() {
                                var scrollTop = utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.scrollTop;
                                if (1 >= scrollTop) {
                                    utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.classList.add('is-ontop');
                                } else {
                                    utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.classList.remove('is-ontop');
                                }
                                if (scrollTop > lastDirection) {
                                    utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.setAttribute('data-direction', 'down');
                                } else if (scrollTop < lastDirection) {
                                    utils_environment__WEBPACK_IMPORTED_MODULE_5__.html.setAttribute('data-direction', 'up');
                                }
                                lastDirection = 0 >= scrollTop ? 0 : scrollTop;
                            });
                        }
                    }, {
                        key: "destroy",
                        ...
                        value: function scrollTo(_ref) {
                            ...
                            this.scroll.scrollTo(target, smooth);
                        }
                    }]);
                    return Scroll;
                }(_19h47_modular__WEBPACK_IMPORTED_MODULE_8__.module);
                /* harmony default export */
                const __WEBPACK_DEFAULT_EXPORT__ = (Scroll);
        ...
        "./node_modules/gsap/ScrollSmoother.js":
            ...
            ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                ...
                __webpack_require__.d(__webpack_exports__, {
                    /* harmony export */
                    ScrollSmoother: () => ( /* binding */ ScrollSmoother),
                    /* harmony export */
                    "default": () => ( /* binding */ ScrollSmoother)
                    /* harmony export */
                });
...
//# sourceMappingURL=src_scripts_modules_Scroll_js.js.map